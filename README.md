...
### Affinities
The directory contains `csv` files of affinities for analyzed profiles. Per each user the `[username].csv` file is created. In addition normalized social distance is calculated for the followers. Per each user the `[username].ncd.csv` file is created.
